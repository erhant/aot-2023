...
// game only allows chip to be a state
...
// Check if none of the rows have empty
...
// Only need to check the currently placed column
type CheckCols<
  T extends any[][],
...
// Check if top-left to bottom-right diagonal is winning
// Only need to check the currently placed column
...
// Returns true if the given array contains four consecutive Vs
